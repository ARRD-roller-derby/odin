...
export default function BlockTraining(){
    ...
    return  <div className={classes.container} ref={ref} data-inview={inView}>
        <h2 className={classes.title}><span className="trash">Les entrainements</span></h2>
...
<div className={classes.training}>
    ...
    <div className={classes.stadium}>Salle LESUEUR - Stade Paul VAUQUELIN</div>
    <div className={classes.street}>Rue Ernest DANET</div>
    <div className={classes.details}>(première salle sur la gauche)</div>
    ...
    <div className={classes.street}>Route de Duclair</div>
